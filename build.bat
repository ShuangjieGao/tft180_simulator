...
"%GCC_CMD%" -fdiagnostics-color=always -g -O2 -Wno-misleading-indentation -I. -Dsimulator main.c image.c zf_device_tft180.c zf_common_function.c avilib.c read_bmp.c -o main.exe -lgdi32 -luser32
